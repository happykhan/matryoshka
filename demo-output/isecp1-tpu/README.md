# Sally Partridge ISEcp1 TPU demonstration

These outputs were generated from the seven complete CMY-like transposition-unit
sequences in `tests/test-data/partridge-examples/TPU_CMY-2-like.fasta`.

- `mara/` contains one locus diagram for each complete reference match.
- `mara-table/` contains the matching position/FID/type/evidence table.
...
is tracked in `docs/mara-parity-spec.md`.

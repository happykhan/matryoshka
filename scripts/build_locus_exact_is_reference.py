#!/usr/bin/env python3
"""Build the exact-IS reference set used by locus structural rules."""
...
def main() -> None:
    ...
    supplied = root / "tests" / "test-data" / "reviewed-examples" / "other_Tn.fasta"
    ...
    records = [
        ...
        SeqRecord(
            ...
            description=(
                ...
                "source_accession=GU595196 provenance=expert_reviewed"
            ),
        ),
        SeqRecord(

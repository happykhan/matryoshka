"""locus tabular SVG output generated from an MGE hierarchy."""
...
def to_locus_table_svg(roots: list[MGEFeature], sample_name: str = "") -> str:
    """Render a locus annotation table as selectable-text SVG."""
    ...
    parts = [
        ...
        _text(MARGIN, 23, sample_name or "Locus table", size=14, weight="bold"),

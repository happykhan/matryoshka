# MARA component inventory and assembly grammar

This is the biological contract for Matryoshka's MARA-compatible annotation.
...
[`matryoshka/mara_component_catalog.yaml`](../matryoshka/mara_component_catalog.yaml).
...
| Layer | Components | Defining evidence | MARA-compatible symbol |
| --- | --- | --- | --- |
...
MARA assembly because their identities and boundaries must be established
...
## Named examples in Sally's material
...
- `matryoshka_demo_SP_comments.pdf`: expert corrections that constrain exact
...
- `Islam_PlasAnn_2026.pdf`: plasmid backbone/function outer layer, kept
  explicitly separate from the core MARA mobile-resistance grammar.
